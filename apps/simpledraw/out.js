...
System.register("interface", [], function (exports_2, context_2) {
    "use strict";
    var DrawType, DrawOption;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_2("DrawOption", DrawOption);
        }
    };
});
System.register("unitdraw", ["constant", "interface"], function (exports_3, context_3) {
    "use strict";
    var constant_1, interface_1, UnitDraw;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_3("UnitDraw", UnitDraw);
        }
    };
});
System.register("canvus", ["unitdraw", "constant"], function (exports_4, context_4) {
    "use strict";
    var unitdraw_1, constant_2, MyCanvus;
    var __moduleName = context_4 && context_4.id;
    return {
        setters: [
            function (unitdraw_1_1) {
                unitdraw_1 = unitdraw_1_1;
            },
            function (constant_2_1) {
                constant_2 = constant_2_1;
            }
        ],
        execute: function () {
            MyCanvus = /** @class */ (function () {
            ...
            exports_4("MyCanvus", MyCanvus);
        }
    };
});
System.register("utils", ["interface"], function (exports_5, context_5) {
    "use strict";
    var interface_2, CommonUtils;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_5("CommonUtils", CommonUtils);
        }
    };
});
// This is main DrawManager function,
System.register("draw", ["canvus", "component"], function (exports_6, context_6) {
    "use strict";
    var canvus_1, component_1, DrawManager, mDrawManager;
    ...
    return {
        ...
        execute: function () {// This is main DrawManager function,
            DrawManager = /** @class */ (function () {
            ...
            exports_6("DrawManager", DrawManager);
            mDrawManager = new DrawManager('canvas', 'canvas1');
...
System.register("component", ["utils", "interface"], function (exports_7, context_7) {
    "use strict";
    var utils_1, interface_3, LineX, TestPoint, LineY, Rect, ALine, Line, Line_D, Line_DD, Text, ClearBox, ComponentManager;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_7("LineX", LineX);
            TestPoint = /** @class */ (function () {
                function TestPoint() {
                    this.points = new Array();
                }
            ...
            exports_7("TestPoint", TestPoint);
            LineY = /** @class */ (function () {
            ...
            exports_7("ClearBox", ClearBox);
            ComponentManager = /** @class */ (function () {
            ...
            exports_7("ComponentManager", ComponentManager);
        }
    };
});
